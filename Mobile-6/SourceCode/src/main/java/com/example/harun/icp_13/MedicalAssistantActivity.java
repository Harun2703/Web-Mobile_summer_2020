package com.example.harun.icp_13;
        ...
        tts = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR) {
                    ...
                    mVoiceInputTv.setText(Html.fromHtml("<p style=\"color:black;\"><b>Speaker</b> : Hello !!</p>"));
                }
            }
        });
            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result != null && result.size() > 0) {
                        mVoiceInputTv.append(Html.fromHtml("<p style=\"color:black;\"><b>User</b> : "+result.get(0)+"</p>"));
                        ...
                        if(result.get(0).equalsIgnoreCase("hello")) {
                            ...
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:black;\"><b>Speaker</b> : What is your name ?</p>"));
                            ...
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:black;\"><b>Speaker</b> : Hello, "+name+"</p>"));
                        }else if(result.get(0).contains("not feeling good")){
                            tts.speak("I can understand. Please tell your symptoms in short",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:black;\"><b>Speaker</b> : I can understand. Please tell your symptoms in short</p>"));
                            ...
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:black;\"><b>Speaker</b> : The time is : "+sdfDate.format(now)+"</p>"));
                        }else if(result.get(0).contains("medicine")){
                            tts.speak("I think you have fever. Please take this medicine.",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:black;\"><b>Speaker</b> : I think you have fever. Please take this medicine.</p>"));
                        } else {
                            tts.speak("Sorry, I cant help you with that", TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:black;\"><b>Speaker</b> : Sorry, I cant help you with that</p>"));
                        }
                    }
                }
                break;
